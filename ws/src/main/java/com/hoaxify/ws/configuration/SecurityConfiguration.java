...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();// default input tokenini etkisiz hale getiriyoruz
		
		http.httpBasic().authenticationEntryPoint(new AuthEntryPoint());//pop-up kapatıyoruz
		
		http.headers().frameOptions().disable();//database console erişebilmek için
